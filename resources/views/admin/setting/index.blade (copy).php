          ...
          <div class="bs-stepper wizard-vertical vertical wizard-vertical-icons-example wizard-vertical-icons mt-2">
             <div class="bs-stepper-header">
                <ul class="nav flex-column nav-pills" id="tab-menu" role="tablist">
                    <li class="nav-item step" role="presentation">
                        <a class="nav-link {{ (Session::get('tab') == 'general') || empty(Session::get('tab')) ? 'active' : '' }}" id="general-tab" data-bs-toggle="pill" href="#general-setting" role="tab">
                            <span class="avatar">
                    ...
                    <li class="nav-item step" role="presentation">
                        <a class="nav-link {{ Session::get('tab') == 'payment' ? 'active' : '' }}" id="payment-tab" data-bs-toggle="pill" href="#payment-setting" role="tab">
                            <span class="avatar">
                                <span class="avatar-initial rounded-2">
                    ...
                    <li class="nav-item step" role="presentation">
                        <a class="nav-link {{ Session::get('tab') == 'smtp' ? 'active' : '' }}" id="mail-tab" data-bs-toggle="pill" href="#mail-setting" role="tab">
                            <span class="avatar">
                                <span class="avatar-initial rounded-2">
                    ...
                    <li class="nav-item step" role="presentation">
                        <a class="nav-link {{ Session::get('tab') == 'seo' ? 'active' : '' }}" id="seo-tab" data-bs-toggle="pill" href="#seo-setting" role="tab">
                            <span class="avatar">
                                <span class="avatar-initial rounded-2">
             ...
             <div class="bs-stepper-content">
                <div class="tab-content" id="tab-content">
                    <div class="tab-pane fade {{ (Session::get('tab') == 'general') || empty(Session::get('tab')) ? 'show active' : '' }}" id="general-setting" role="tabpanel">
                    ...
                    <div class="tab-pane fade {{ (Session::get('tab') == 'payment') ? 'show active' : '' }}" id="payment-setting" role="tabpanel">
                        <div class="content-header mb-4">
                    ...
                    <div class="tab-pane fade {{ (Session::get('tab') == 'smtp') ? 'show acive' : '' }}" id="mail-setting" role="tabpanel">
                        <div class="content-header mb-4">
                    ...
                    <div class="tab-pane fade {{ (Session::get('tab') == 'seo') ? 'show acive' : '' }}" id="seo-setting" role="tabpanel">
                        <div class="content-header mb-4">
