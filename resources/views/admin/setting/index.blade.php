          ...
          <div class="bs-stepper wizard-vertical vertical wizard-vertical-icons-example wizard-vertical-icons mt-2">
             <div class="bs-stepper-header">
                <ul class="nav flex-column nav-pills" id="tab-menu" role="tablist">
                    <li class="nav-item setting-tab" role="presentation">
                        <a class="nav-link step {{ (Session::get('tab') == 'general') || empty(Session::get('tab')) ? 'active' : '' }}" id="general-tab" data-bs-toggle="pill" href="#general-setting" role="tab">
                            <span class="avatar">
                    ...
                    <li class="nav-item setting-tab" role="presentation">
                        <a class="nav-link step {{ (Session::get('tab') == 'payment') ? 'active' : '' }}" id="payment-tab" data-bs-toggle="pill" href="#payment-setting" role="tab">
                            <span class="avatar">
                                <span class="avatar-initial rounded-2">
                    ...
                    <li class="nav-item setting-tab" role="presentation">
                        <a class="nav-link step {{ (Session::get('tab') == 'smtp') ? 'active' : '' }}" id="mail-tab" data-bs-toggle="pill" href="#mail-setting" role="tab">
                            <span class="avatar">
                                <span class="avatar-initial rounded-2">
                    ...
                    <li class="nav-item setting-tab" role="presentation">
                        <a class="nav-link step {{ (Session::get('tab') == 'seo') ? 'active' : '' }}" id="seo-tab" data-bs-toggle="pill" href="#seo-setting" role="tab">
                            <span class="avatar">
                                <span class="avatar-initial rounded-2">
             ...
             <div class="bs-stepper-content">
                <div class="tab-content" id="tab-content">
                    <div class="tab-pane fade content {{ (Session::get('tab') == 'general') || empty(Session::get('tab')) ? 'show active' : '' }}" id="general-setting" role="tabpanel">
                    ...
                    <div class="tab-pane fade content {{ (Session::get('tab') == 'payment') ? 'show active' : '' }}" id="payment-setting" role="tabpanel">
                        <div class="content-header mb-4">
                    ...
                    <div class="tab-pane fade content {{ (Session::get('tab') == 'smtp') ? 'show active' : '' }}" id="mail-setting" role="tabpanel">
                        <div class="content-header mb-4">
                    ...
                    <div class="tab-pane fade content {{ (Session::get('tab') == 'seo') ? 'show active' : '' }}" id="seo-setting" role="tabpanel">
                        <div class="content-header mb-4">
                            <h6 class="mb-0">Mail Setting</h6>
                        </div>
                        <form id="seoSettingForm" method="post" action="{{ route('admin.seo.settings') }}" enctype="multipart/form-data">
                            ...
                            <div class="row g-6">
                                <div class="col-sm-12">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" id="meta_title" value="{{ $seoSetting['meta_title'] ?? '' }}" name="meta_title" class="form-control" placeholder="Meta title" />
                                ...
                                <div class="col-sm-12">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" id="og_title" value="{{ $seoSetting['og_title'] ?? '' }}" name="og_title" class="form-control" placeholder="Meta title" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if (isset($seoSetting['og_image']))
                                        <img class="img-fluid rounded mb-4" id="og_img_preview" src="{{asset('storage/'.$seoSetting['og_image'])}}" height="120" width="120" alt="og Image">
                                    @else
                                        <img class="img-fluid rounded mb-4" id="og_img_preview" src="{{asset('backend/assets/img/no-image.jpg')}}" height="120" width="120" alt="og image">
                                    @endif
